...
ggplot(elec_heat, aes(x = Year, y = co2_from_heat_electricity, color = Country))+
  geom_line()+
  labs(title = "Per capita CO2 emissions from electricity and heat",subtitle = "Countries compared with Italy: France, Germany, UK, US, China and Europian Union", x = "", y= "Per capita CO2 emissions")+
  theme_classic()
```
