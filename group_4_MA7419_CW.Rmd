...
ggplot(elec_heat, aes(x = year, y = co2_from_heat_electricity, color = country))+
  geom_line(key_glyph = "timeseries",size=1.3)+
  labs(title = "Per capita CO2 emissions from electricity and heat",subtitle = "Italy compared with UK, France, Germany, China and US", x = "", y= "Per capita CO2 emissions")+
  theme_classic()+
  theme(plot.title = )
```
