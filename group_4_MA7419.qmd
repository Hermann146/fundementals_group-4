...
|----|----|----|
| **Research Question** | Compare Italy's CO~2~ emissions reduction using renewable electricity and total emissions against global peers. | Focuses on Italy's environmental performance and global comparison. |
| **Data Sources** | Used datasets from Our World in Data (OWID). | OWID is a reliable, public, and accessible source for international comparison. |
| **Data Cleaning** | Cleaned column names, filtered data to relevant countries/years, and removed N/A values. | Ensures consistency and accuracy for a fairer comparison. |
| **Visuals** | Used line graphs, an area chart, and a pie chart, highlighting Italy's data. | Visuals effectively show trends over time (line/area charts) and single-year comparisons (pie chart). |
...
#   arrange(desc(emission))
# c2$entity <- factor(c2$entity, levels = maxt$entity)
...
-   Italy’s CO2 emissions from electricity and heat showed a moderate increase between 1990 and 2006.

-   Following this period, the figures declined steadily up to 2020, before rising again from 2020 to 2022.

-   Italy releases CO2 through heat and electricity less than every other country, and US is in peak level, which shows Italy is showing more concern towards usage of carbon electricity.
...
-   Italy relies far more on gas than the EU and USA, making its energy mix less diversified and raising public concern about price stability and supply risks.
...
Italy has successfully reduced carbon emissions, showing a clear downward long-term trend.

Its reduction pace is stronger than many EU peers, though not the fastest in Western Europe.

Compared with the USA, Italy relies more on regulation and carbon pricing rather than subsidies.

Compared with China, Italy cuts emissions more consistently but lacks China’s rapid large-scale infrastructure deployment.

Overall: Italy performs relatively well, but future progress requires faster decarbonization in transport and buildings.
