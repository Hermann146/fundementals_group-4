...
graph <- graph |> layout(annotations = list(
    list(text = "Italy", x = 0.12, y = 1.03, showarrow = FALSE, xref='paper', yref='paper'),
    list(text = "European Union", x = 0.97, y = 1.03, showarrow = FALSE, xref='paper', yref='paper'),
    list(text = "USA", x = 0.12, y = 0.48, showarrow = FALSE, xref='paper', yref='paper'),
    list(text = "China", x = 0.94, y = 0.50, showarrow = FALSE, xref='paper', yref='paper')
  )
)
graph
