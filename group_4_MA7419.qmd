...
To compare Italy with other countries in total CO2 emissions, we created a line chart showing emissions trends over time. This helped identify Italy’s performance compared to other countries.

For Italy’s per-capita CO2 emissions by sector, we used three different visualizations: bar, line, and area charts. These charts depicted a clear view of which sectors contributed most to emissions and how trends changed over the years.
